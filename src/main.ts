...
function onGameTerminated(aborted = false): void {
  // Submit score data
  ScoreTracker.getInstance().submitScore(aborted);
...
// Export score tracker types and functions for external use
export type { ScoreData, ScoreCallback, ScoreTrackerConfig } from "./score-tracker.ts";
export { configureTuxRacerScoreTracking } from "./score-tracker.ts";
